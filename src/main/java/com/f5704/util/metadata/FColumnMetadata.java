...
public class FColumnMetadata{
    ...
    FColumnMetadata(ResultSet rs , boolean upcase) throws SQLException {
    ...
    FColumnMetadata(String name , String typeName , int typeCode , int colunmSize) throws SQLException {
        this.name = name ;
