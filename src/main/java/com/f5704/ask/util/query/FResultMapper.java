package com.f5704.ask.util.query;
...
public class FResultMapper extends AbstractResultMapper {

	private MappingContext<? extends ElasticsearchPersistentEntity<?>, ElasticsearchPersistentProperty> mappingContext;

	public FResultMapper() {
		super(new DefaultEntityMapper());
	}

	public FResultMapper(MappingContext<? extends ElasticsearchPersistentEntity<?>, ElasticsearchPersistentProperty> mappingContext) {
		super(new DefaultEntityMapper());
		this.mappingContext = mappingContext;
	}

	public FResultMapper(EntityMapper entityMapper) {
		super(entityMapper);
	}
