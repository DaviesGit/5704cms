...
import com.f5704.ask.util.disruptor.UserEventHandler;
import com.f5704.ask.util.disruptor.UserHistoryEventFactory;
import com.f5704.core.FDataContext;
import com.f5704.util.DateConverter;
import com.f5704.util.event.UserDataEvent;
import com.lmax.disruptor.dsl.Disruptor;

@EnableAutoConfiguration
@SpringBootApplication
@EnableJpaRepositories("com.f5704.ask.service.repository")
...
//      
	...
	public static void main(String[] args) {
		FDataContext.setApplicationContext(SpringApplication.run(Application.class, args));
	}
