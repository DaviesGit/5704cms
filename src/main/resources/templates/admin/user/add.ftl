<div class="f5704-layui-form">
	<form  method="post" class="layui-form f5704-form" action="/admin/user/save">
      ...
      <div class="layui-field-box">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-inline">
                  ...
                  <div class="layui-input-block">
                    <input type="checkbox" <#if userData.gender?? && userData.gender == "男">checked</#if>  <#if 0==userData.usertype>checked</#if> name="usertype" lay-skin="switch"  lay-filter="" lay-verify="required"  lay-text="系统管理员|普通用户">
                  </div>
            <#--  <label class="layui-form-label required">用户类型：</label>
            <div class="layui-input-block">
...
<#--  
	  ...
	  <div class="layui-form-item">
	    <label class="layui-form-label">城市</label>
	    <div class="layui-input-inline">
	      <input type="text" id="province" name="province" placeholder="用户所在省份" autocomplete="off" class="layui-input">
	    </div>
	    <div class="layui-form-mid layui-word-aux">
	    	<input type="text" id="city" name="city" placeholder="用户所在城市" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	  <div class="layui-form-item">
	    <label class="layui-form-label required">手机号</label>
	    <div class="layui-input-inline">
	      <input type="mobile" name="mobile" required lay-verify="required"  placeholder="请输入手机号码" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	  <div class="layui-form-item">
	    <label class="layui-form-label required">个性签名</label>
	    <div class="layui-input-inline">
	      <input type="memo" name="memo" required lay-verify="required"  placeholder="个性签名" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	  <div class="layui-form-item">
	    <label class="layui-form-label">系统管理员</label>
	    <div class="layui-input-block">
	      <input type="checkbox" name="usertype" lay-skin="switch" value="1">
	    </div>
	  </div>  -->
...
//});
      layui.use(['laydate','form','jquery'], function () {
        ...
        layui.form.on('submit(add_user)', function(data){
