<div class="row">
	<div class="col-lg-12">
		<h1 class="site-h1" style="background-color:#FFFFFF;">
			回复排行<#if userList??>（${userList.totalElements!''}）</#if>
		</h1>
				...
				<table class="layui-table" lay-skin="line">
				  ...
				  <thead>
					<tr>
					  ...
					  <th>管理员</th>
					  <th>注册时间</th>
					  <th style="white-space:nowrap;" nowrap="nowrap">回复数量</th>
					</tr> 
				  </thead>
				  <tbody>
					<#if defaultTopicCommentList?? && defaultTopicCommentList.content??>
					<#list defaultTopicCommentList.content as topic>
					<tr>
					  <td>
