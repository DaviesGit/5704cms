<div class="f5704-layui-form">
	<form id="edit_achievement_form" method="post" class="layui-form f5704-form" action="/admin/achievement/update">
    ...
    <fieldset class="layui-elem-field">
      ...
      <div class="layui-field-box">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="text" readonly lay-verType="tips" value="${achievementData.id!''}" name="id" lay-verify="" lay-reqText="此信息不能为空"
        ...
        <script>
          layui.use(['table','jquery','layer'],function(){
            ...
            layui.$('#edit_achievement_form').submit(function(data){
              let user_sno=[];
	  ...
	  <div class="layui-form-button">
	    <div class="layui-button-block">
	      <button class="layui-btn" lay-submit lay-filter="edit_achievement">立即提交</button>
