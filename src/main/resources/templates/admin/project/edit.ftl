<div class="f5704-layui-form">
	<form id="edit_project_form" method="post" class="layui-form f5704-form" action="/admin/project/update">
    ...
    <fieldset class="layui-elem-field">
      ...
      <div class="layui-field-box">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="text" readonly lay-verType="tips" value="${projectData.id!''}" name="id" lay-verify="" lay-reqText="此信息不能为空"
        ...
        <script>
          layui.use(['table','jquery','layer'],function(){
            ...
            layui.$('#edit_project_form').submit( function(data){
              principal_user_list[0]&&$('[name="principal"]').val(principal_user_list[0].id);
            });
          });
        </script>
	  ...
	  <div class="layui-form-button">
	    <div class="layui-button-block">
	      <button class="layui-btn" lay-submit lay-filter="edit_project">立即提交</button>
