  ...
  <div class="section-inner start-page-content">
    ...
    <div class=page-content>
      <div class=row style="width: 100%;">
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class=about-me>
            <div class=block-title>
              <h3> 项目 <span>简介</span></h3>
            </div>
            <p>
              ${projectData.description!'无'}
            </p>
            <div class=block-title>
              <h3> 项目 <span>备注</span></h3>
            </div>
            <p>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <ul class=info-list>
            <li><span class=title>项目名称</span><span class=value>${projectData.name!''}</span></li>
            <li><span class=title>项目负责人</span><span class=value>${projectData.principal.name!''}</span></li>
            <li><span class=title>项目比赛</span><span class=value>${projectData.match!''}</span></li>
            <li><span class=title>项目进度</span><span class=value>${projectData.progress!''}</span></li>
            <li><span class=title>开始时间</span><span class=value>${projectData.begin!''}</span></li>
            <li><span class=title>结束时间</span><span class=value>${projectData.end!''}</span></li>
          </ul>
        </div>
      </div>
    </div>
     <#assign parent_id_prifix='project_' >
     <#assign is_in_profile_page=true >
    <div style="font-size:14px; margin-bottom: 30px;">
        <div class="layui-collapse">
        <div class="layui-colla-item">
            <h2 class="layui-colla-title">项目成员</h2>
            <div class="layui-colla-content layui-show">
                <#if (projectData.users)??>
                <#assign userList=projectData.users>
                </#if>
                <#include "/component/list/user.ftl">
            </div>
        </div>
        <div class="layui-colla-item">
            <h2 class="layui-colla-title">项目成果</h2>
            <div class="layui-colla-content layui-show">
                <#if (projectData.achievements)??>
                <#assign achievementList=projectData.achievements>
                </#if>
