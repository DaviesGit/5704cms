    ...
    <style>
      ...
      } /* @font-face {font-family: "youyuan";src: url("../fonts/youyuan.TTF");} */
      <#--  * {
        margin: 0;
        padding: 0;
        ...
        -webkit-box-sizing: border-box; /* font-family: "youyuan"; */
        font-weight: normal;
      }
      html {
        font-size: 62.5%;
      ...
      section.page_two .con_wrap,
      section.page_three .con_wrap,
      section.page_four .con_wrap,
      section.page_five .con_wrap,
      section.page_six .con_wrap {
      ...
      .tit_wrap .scissors span {
        width: 20px;
        height: 20px;
        float: left; /* background: url(../images/sprite_img.png) no-repeat -37px -50px; */
      }
      .tit_wrap h2 {
        margin:0 0 0 0;
        padding: 0 50px;
      ...
      .down_arrow a span {
        ...
        height: 18px;
        display: block;
        margin: 15px; /* background: url(../images/sprite_img.png) no-repeat -18px -50px; */
      ...
      .arrowpart {
        float: left;
        width: 15px;
        height: 50px; /* background: url(../images/arrow-left.png) no-repeat 0 23px; */
      }
      .exCon {
        background: #fff;
      ...
      ul.con_style li span {
        ...
        height: 50px;
        display: block;
        margin: 0 auto 20px; /* background: url("../images/sprite_img.png"); */
      }
      ul.con_style li p {
        text-align: center;
        font-size: 1.8rem;
    ...
    <section class="page_two" id="page2" style=" display: block;">
      <div class="con_wrap" style="padding: 0;  box-shadow: 0 15px 25px 0 rgba(0, 0, 0, 0.1); border-radius: 15px;">
        <div class="page-header" style="   width: 100%;  height: 880px; position:absolute; z-index:-100;   background-image: url(/images/sp_main_bg.jpg);background-size: cover;-webkit-background-size: cover;">
        ...
        <div class="myinfo">
          <table>
            <tbody>
                <tr><td rowspan="6"><img style="max-width: 250px;" src="/res/image/${userData.id!''}" /></td><td><span>姓名</span> | ${userData.name!''}</td> <td><span>昵称</span> | ${userData.nickname!userData.name!userData.username!''}</td></tr>
                <tr><td><span>性别</span> | ${userData.gender!''}</td> <td><span>城市</span> | ${userData.city!''}</td></tr>
                <tr><td><span>省份</span> | ${userData.province!''}</td> <td><span>语言</span> | ${userData.language!''}</td></tr>
                <tr><td><span>年级</span> | ${userData.grade!''}</td> <td><span>专业</span> | ${userData.major!''}</td></tr>
                <tr><td><span>学号</span> | ${userData.sno!''}</td> <td><span>寝室号</span> | ${userData.room_id!''}</td></tr>
                <tr><td><span>邮箱</span> | ${userData.email!''}</td> <#--  <td><span>成员等级</span> | ${userData.rank!''}</td>  --></tr>
                <tr>
                    <td><span>技能</span> | ${userData.skill!''}</td>
                    <td><span>头衔</span> | ${userData.title!''}</td>
                    <td><span>生日</span> | ${userData.birthday!''}</td>
                </tr>
                <tr>
                    <td><span>加入时间</span> | ${userData.join_time!''}</td>
                    <td><span>部门</span> | ${userData.department!''}</td>
                    <td><span>组织</span> | ${userData.organ!''}</td>
                </tr>
                <tr>
                    <td><span>工作名称</span> | ${userData.jobtitle!''}</td>
                    <td><span>描述</span> | ${userData.description!''}</td>
                    <td><span>备注</span> | ${userData.remark!''}</td>
                </tr>
            </tbody>
          </table>
            <#assign parent_id_prifix='user_' >
            <#assign is_in_profile_page=true >
          <div style="font-size:14px">
            <div class="layui-collapse">
            <div class="layui-colla-item">
                <h2 class="layui-colla-title">参与的项目</h2>
                <div class="layui-colla-content layui-show">
                    <#assign projectList=userData.projects>
                    <#include "/component/list/project.ftl">
                </div>
            </div>
            <div class="layui-colla-item">
                <h2 class="layui-colla-title">获得的成果</h2>
                <div class="layui-colla-content layui-show">
                    <#assign achievementList=userData.achievements>
