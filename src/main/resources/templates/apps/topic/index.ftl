	    ...
	    <div class="content">
	      <div class="fly-tab">
	        <span>
	          ...
	          <a href="/activity" <#if subtype?? && subtype == "activity">class="tab-this"</#if>>活动</a>
	          <a href="/not_graduated" <#if subtype?? && subtype == "not_graduated">class="tab-this"</#if>>在校</a>
	          <a href="/graduated" <#if subtype?? && subtype == "graduated">class="tab-this"</#if>>毕业</a>
	          <a href="/essence" <#if subtype?? && subtype == "essence">class="tab-this"</#if>>精帖</a>
	          <#if user??>
	          	<a href="/my" <#if subtype?? && subtype == "my">class="tab-this"</#if>>我的帖</a>
	          </#if>
	          <a href="/all" <#if subtype?? && subtype == "all">class="tab-this"</#if>>全部</a>
	        </span>
	        <form method="post" action="/${subtype!''}" class="fly-search">
